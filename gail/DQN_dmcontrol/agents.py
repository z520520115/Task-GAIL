...
class BaseAgent:
    ...
    def eval(self, env, verbose=True):
        raise NotImplementedError()
...
class DQNAgent(BaseAgent):
    ...
    def train(self, env, save_model=True, verbose=True, display=True, save_training_curve=True):
        if verbose:
    ...
    def eval(self, env, verbose=True, display=True):
        if verbose:
...
def create_agent(model_name, env, verbose=True):
